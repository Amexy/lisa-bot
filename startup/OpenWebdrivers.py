...
def LoadWebDrivers(server: str):
    ...
    if server == 'en':
        ...
        enDriver.find_element_by_xpath('//*[@id="app"]/div[4]/div[2]/div[1]/div[2]/a').click()
        return enDriver
    if server == 'jp':
        global jpDriver
        ...
        jpDriver.find_element_by_xpath('//*[@id="app"]/div[4]/div[2]/div[1]/div[2]/a').click()
        return jpDriver
    if server == 'cn':
        global cnDriver
        ...
        cnDriver.find_element_by_xpath('//*[@id="app"]/div[4]/div[2]/div[1]/div[2]/a').click()
        return cnDriver
    if server == 'tw' or server == 'kr':
        ...
        twkrDriver.find_element_by_xpath('//*[@id="app"]/div[4]/div[2]/div[1]/div[2]/a').click()
        return twkrDriver
